...
public class SignupOne extends JFrame implements ActionListener {
	...
	long random;
	JTextField nameTextField, fnameTextField, emailTextField, addTextField, pinTextField, stateTextField, cityTextField;
	...
	public SignupOne() {
		...
		ButtonGroup marButtonGroup = new ButtonGroup();
		marButtonGroup.add(married);
		marButtonGroup.add(unmarried);
		marButtonGroup.add(other);
	...
	public void actionPerformed(ActionEvent e) {
		...
		String formno = first; // by putting "" in front and + it returns a String
